...
async function main() {
  ...
  assert.match(canvasRendering, /video\.addEventListener\("dblclick"/);
  assert.match(canvasRendering, /toggleVideoPlayback\(\)/);
  assert.match(canvasRendering, /createCanvasNodeInteractionHint\("双击播放 · 按住拖动"\)/);
